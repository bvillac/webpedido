...
function mostrarTienda(Data){
    ...
    $('#txt_TIE_NOMBRE').val(Data[0]['TIE_NOMBRE']);
    $('#txt_TIE_DIRECCION').val(Data[0]['TIE_DIRECCION']);
    $('#txt_TIE_TELEFONO').val(Data[0]['TIE_TELEFONO']);
    $('#txt_TIE_CUPO').val(Data[0]['TIE_CUPO']);
    $("#cmb_cliente option[value="+data[0]['CLI_ID']+"]").attr("selected",true);
    $("#cmb_dia_ini option[value="+data[0]['FEC_INI_PED']+"]").attr("selected",true);
    $("#cmb_dia_fin option[value="+data[0]['FEC_FIN_PED']+"]").attr("selected",true);
    $('#txt_TIE_CONTACTO').val(Data[0]['TIE_CONTACTO']);
    $('#txt_TIE_LUG_ENTREGA').val(Data[0]['TIE_LUG_ENTREGA']);
