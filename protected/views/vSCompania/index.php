...
<div class="col-lg-12">
    ...
    <?php echo CHtml::button(Yii::t('CONTROL_ACCIONES', 'Delete Selection'), array('id' => 'btn_DeleteSelection', 'name' => 'btn_DeleteSelection', 'class' => 'btn btn-primary btn-sm', 'onclick' => 'fun_eliminarSeleccion()')); ?>
</div>
<div class="col-lg-12">
