...
<div class="col-lg-12">
    ...
    <?php echo CHtml::button(Yii::t('CONTROL_ACCIONES', 'Delete'), array('id' => 'btn_Delete', 'name' => 'btn_Delete', 'class' => 'btn btn-primary btn-sm', 'onclick' => 'fun_Delete()')); ?>
    <?php echo CHtml::link(Yii::t('CONTROL_ACCIONES', 'Edit'),array('vSCompania/update'), array('id' => 'btn_Update', 'name' => 'btn_Update','title' => Yii::t('CONTROL_ACCIONES', 'Edit'),'class' => 'btn btn-primary btn-sm','onclick' => 'fun_Update()'));    ?>
</div>
<div class="col-lg-12">
